        ...
        <div class="row">
            <div class="col-12 col-xl-6 no-padding">
                <div class="blog-content flex">
                    <figure>
                        <a href="#"><img src="images/blog/1.jpg" alt="car"></a>
                    </figure>

                    <div class="entry-content flex flex-column justify-content-between align-items-start">
                        <header>
                            <h3><a href="blog/single-standard.html">The inside spring!</a></h3>
            ...
            <div class="col-12 col-xl-6 no-padding">
                <div class="blog-content flex">
                    ...
                    <div class="entry-content flex flex-column justify-content-between align-items-start">
                        <header>
                            <h3><a href="blog/single-fairytale.html">Not a fairy-tale, but a story</a></h3>
            ...
            <div class="col-12 col-xl-6 no-padding">
                <div class="blog-content flex">
                    ...
                    <div class="entry-content flex flex-column justify-content-between align-items-start">
                        <header>
                            <h3><a href="#">The farm girl I met.</a></h3>
